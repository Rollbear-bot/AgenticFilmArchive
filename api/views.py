...
from api.serializers import (
    ResourceListSerializer, ResourceSerializer, ResourceSearchSerializer,
    ChatMessageSerializer, ChatResponseSerializer, SyncResponseSerializer,
    HealthCheckSerializer, ConfigSerializer
)
...
def resource_sync_api(request):
    ...
    total_scanned = (img_result.get('count', 0) + img_result.get('skipped', 0) +
                     doc_result.get('count', 0) + doc_result.get('skipped', 0))
